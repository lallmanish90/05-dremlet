...
def find_lecture_folders(input_dir: str) -> Dict:
    ...
    # Debug information (removed sidebar writes to avoid navigation conflicts)
    ...
    # Debug info (moved from sidebar to avoid navigation conflicts)
    # Found {len(folder_types)} folder types and {sum(len(lectures) for lectures in organized_data.values())} lectures
