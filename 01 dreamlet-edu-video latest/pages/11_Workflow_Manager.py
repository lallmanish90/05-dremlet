...
def get_workflow_state_dir() -> str:
    ...
    state_dir = os.path.join(os.getcwd(), ".streamlit", "workflow_state")
    ensure_directory_exists(state_dir)
    return state_dir

def get_templates_dir() -> str:
    """Get workflow templates directory"""
    templates_dir = os.path.join(os.getcwd(), ".streamlit", "workflow_templates")
    ensure_directory_exists(templates_dir)
    return templates_dir

def get_checkpoints_dir() -> str:
    """Get checkpoints directory"""
    checkpoints_dir = os.path.join(os.getcwd(), ".streamlit", "checkpoints")
