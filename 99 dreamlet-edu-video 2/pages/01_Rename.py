...
def main():
    ...
    with st.expander("Examples of Renaming Rules"):
        ...
        **Transcript Files (to be renamed as "Lecture XX"):**
        ...
        - `lecture_06_artifact_b.md` → `Lecture 06.md`
        ...
        **Slide Files (to be renamed as "XX-slides"):**
        ...
        - `lecture_06_artifact_c.md` → `06-slides.md`
        - `lecture01_slide_content.md` → `01-slides.md`
        - `lecture59_slide_content.md` → `59-slides.md`
        
        **Summary Files (to be renamed as "XX-summary"):**
        - `01-d.md` → `01-summary.md`
        - `27-artifact-d.txt` → `27-summary.txt`
        - `lecture_06_artifact_d.md` → `06-summary.md`
        - `lecture_11_summary.md` → `11-summary.md`
        - `lecture01_summary.md` → `01-summary.md`
        - `lecture01_video_summary.md` → `01-summary.md`
        - `lecture60_video_summary.md` → `60-summary.md`
        
        **Note:** Files without clear lecture numbers (like `video_transcript.md`, `slide_content.md`) will be skipped as lecture numbers are required for proper organization.
